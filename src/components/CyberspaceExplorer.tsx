  ...
  return (
    <div className="relative h-dvh w-dvw overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 p-4">
        <div className="pointer-events-auto w-full max-w-xl rounded-xl border border-white/10 bg-black/60 p-4 text-sm text-zinc-100 backdrop-blur">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              title="Toggle NEW mode on and jump to latest-seen height"
            >
              NEW {newMode ? 'ON' : 'OFF'}
            </button>
          </div>
          ...
          >
            ...
            />
            <button type="submit" className="rounded-lg bg-emerald-500/20 px-3 py-2 text-sm font-semibold text-emerald-200">
              Jump
            </button>
          </form>
